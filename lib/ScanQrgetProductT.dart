...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: QRScanScreenPutTT(),
    );
  }
}

class QRScanScreenPutTT extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => _QRScanScreenPutState();
}

class _QRScanScreenPutState extends State<QRScanScreenPutTT> {
  ...
  Future<void> updateProductQuantity(String productCode) async {
    ...
    if (currentQuantity == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('$formattedTime NHẬP THÀNH CÔNG!')),
      );
